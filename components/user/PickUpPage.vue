    ...
    <div class="md:flex w-screen h-screen">
      <div class="md:w-1/3 pl-10">
        ...
        <p class="text-gray-900 text-xl">
          Sei bitte zur angegebenen Zeit zu Hause.
        </p>
      ...
      <div class="md:w-2/3 p-2 h-full">
        <div class="rounded-lg p-6 md:p-12 bg-gray-900 min-h-full">
          <p class="text-white">Vielen Dank - Wir holen dein Gerät ab. Du hast eine Email mit weiteren Informationen erhalten.</p>
        </div>
      </div>
    </div>
  </div>
